    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Nur Cahyaningsih");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Nur Cahyaningsih");
                mPerson.setAge(17);
                mPerson.setEmail("nurcahya2443@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "088218233727";
